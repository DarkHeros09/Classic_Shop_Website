...
var PrivacyContent = map[string]model.PrivacyPageData{
	"en": {
		MetaTitle:   "Privacy Policy - Classic Fashion",
		MetaDesc:    "Learn how Classic Fashion collects, uses, and protects your personal shopping data.",
		Title:       "Privacy Policy",
		LastUpdated: "Last updated: January 3, 2026",
		Intro:       "Welcome to Classic Fashion. We value your trust and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and share your data when you shop for clothing and accessories through our mobile application and website.",
		...
		Contact: model.ContactSection{
			...
			Email:   "privacy@classic-app.com",
		},
	},
	"ar": {
		MetaTitle:   "سياسة الخصوصية - كلاسيك للأزياء",
		MetaDesc:    "تعرف على كيفية جمع واستخدام وحماية بيانات التسوق الخاصة بك في كلاسيك.",
		Title:       "سياسة الخصوصية",
		LastUpdated: "آخر تحديث: 3 يناير 2026",
		Intro:       "مرحبًا بك في كلاسيك للأزياء. نحن نقدر ثقتك ونلتزم بحماية معلوماتك الشخصية. تشرح سياسة الخصوصية هذه كيفية جمع بياناتك واستخدامها ومشاركتها عند التسوق لشراء الملابس والإكسسوارات.",
		Sections: []model.PrivacySection{
			{
